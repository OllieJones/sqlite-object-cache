...
On Linux, you can run your WP-CLI shell commands like this:  `sudo -u www-data wp config list`  This ensures they run with the same user as the web server. Please notice that version 1.6.4 of the plugin contains a fix to reduce the chance of this problem affecting you.
